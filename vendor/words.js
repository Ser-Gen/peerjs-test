// BIP-39 English word list (2048 words; the first 4 letters of each word are unique).
// From @scure/bip39 2.3.0, wordlists/english.js — MIT License, Copyright (c) 2022 Patricio Palladino,
// Paul Miller (paulmillr.com). The list itself comes from BIP-39 (github.com/bitcoin/bips).
// PeerKit uses it for room codes: 4 words ≈ 44 bits.
export const WORDS = `
